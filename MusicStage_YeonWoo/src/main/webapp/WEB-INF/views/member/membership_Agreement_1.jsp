...
<body>
       <div>
        ...
        <div>
           ...
           <span id="content_frame">
               <form  action="join2.me" accept-charset="UTF-8" method="POST" onsubmit="return checkValidate();">
               <div style="text-align: left;">
                <img src="${pageContext.request.contextPath}/resources/images/check_1.PNG" style="width: 150px;">
                </div>    
                <p class="content_frame_first">
                        <span>회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.</span>
                        <div>
                            <p class="content_frame_first_first">
                                <img><b class="end_text">회원가입약관</b> 
                            </p>
                            <p class="content_frame_first_second">
                                제 1장 총칙
                            ...
                            <p class="content_frame_first_first">
                                <input type="checkbox" name="checkbox1" class="checkbox_1" >
                                <b class="end_text" >회원가입약관의 내용에 동의합니다.</b> 
                            </p>
                        </div>
                </p>
                    <p>
                        <div>
                            <p class="content_frame_second" >
                                <img><b class="end_text">개인정보처리방법안내</b> 
                            </p>
                            <table class="table_frame">
                                ...
                                <tr>
                                    <td >
                                        고객서비스 이용에 관한 동지,C5대응을 위한 이용자 식별
                                    </td>
                                    <td>
                                        연락처(이메일,휴대전화번호)
                                    </td>
                            ...
                            <p class="content_frame_second">
                                <input type="checkbox" name="checkbox2" class="checkbox_1"><b class="end_text" >개인정보처리방침안내의 내용에 동의합니다.</b> 
                            </p>
                        </div>
                    </p>
                        ...
                        <div>
                            <p  class="content_frame_second">
                                <img>
                                <b class="end_text" >
                                    불법 복제 소프트 사용하거나 사용 질문시 아이디 정지합니다.
                                </b> 
                            </p>
                            <p class="content_frame_second">
                                <input type="checkbox" name="checkbox3" class="checkbox_1" ><b class="end_text" >동의합니다.</b> 
                            </p>
                        </div>
                    <p>
                        <div>
                            <p  class="content_frame_second">
                                <img><b class="end_text" >가입정보 장난,허위 기재시 아이디 정지 됩니다.</b> 
                            </p>
                            <p style="line-height: 50px; border-style: solid; margin-top: 0px; margin-bottom: 0px; background-color: white; border-width:1px; margin-left: auto; margin-right: auto; border-color:#e4e5ed; width: 700px; height: 50px; text-align: left ; display: block;">
                                가입정보 비어 있거나 장난 허위기재, 2중 아이디 생성시 아이디 정지됩니다.
                            </p>
                            <p class="content_frame_second">
                                <input type="checkbox" name="checkbox4" class="checkbox_1" ><b class="end_text">동의합니다.</b> 
                            </p>
                        </div>
                    </p>
                    <div>
                        <p class="content_frame_second">
                            <img><b class="end_text" >회원가입후 "전문가 등록 과정 중 관리자 승인후 전문가 활동 가능합니다."</b> 
                        </p>
                        <p class="content_frame_second">
                            <input type="checkbox" name="checkbox5" class="checkbox_1" ><b class="end_text" >회원가입약관의 내용에 동의합니다.</b> 
                        </p>
                    </div>
                   	<c:if test="${not empty kakaoToken}">
                   		<input type="hidden" name="kakaoToken" value="${kakaoToken}">
                   	</c:if>
                    <input type="submit" value="다음" class="button_css">
                </form>
            </span>
        </div>  
    </div>
    ...
    <script>
    	function checkValidate(){
    		...
    		var allNum = $(".checkbox_1").length
			
    		var checkedNum = $(".checkbox_1:checked").length
