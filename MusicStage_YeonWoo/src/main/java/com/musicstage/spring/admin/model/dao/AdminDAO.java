...
public interface AdminDAO {
	...
	int selectSearcProApproveListCount(String searchCondition);
	...
	void updateMemberReportYes(int report_no);
	void updateMemberReportCount(String report_member);
	void updateMemberReportNo(int report_no);
	void updateBoardReportYes(int report_no);
	void updateBoardReportCount(int report_board);
	void updateBoardReportNo(int report_no);
	void updateProApproveYes(int register_no);
	void updateProApproveStatusYes(String register_user);
	void updateProApproveStatusNo(String register_user);
	void updateProApproveNo(int register_no);
